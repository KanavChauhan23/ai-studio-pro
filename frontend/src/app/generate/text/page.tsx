...
export default function Page() {
  return <ToolPage title="Text Generator" description="Generate blogs, social posts, product copy and more with AI" icon="📝" badge="Groq · Llama 3.3 70B" apiEndpoint="/api/generate/text"
    fields={[
      {name:'prompt',label:'What to write',type:'textarea',placeholder:'Write a detailed blog post about the future of AI in healthcare…',rows:5},
