...
const TOOLS = [
  ...
  { icon: "📺", title: "YouTube Script", desc: "Generate YouTube scripts", href: "/tools/youtube" },

  { icon: "🔎", title: "Web Search", desc: "AI powered search", href: "/tools/web-search" },

  { icon: "📚", title: "Study Notes", desc: "Generate study notes", href: "/tools/study-notes" },

  { icon: "📝", title: "Summarize Text", desc: "Summarize long text", href: "/tools/summarize" },

  { icon: "📑", title: "Summarize Document", desc: "Summarize documents", href: "/tools/summarize-doc" },

  { icon: "✨", title: "Prompt Improver", desc: "Improve AI prompts", href: "/tools/improve-prompt" },

  { icon: "📱", title: "Social Media Post", desc: "Generate social media posts", href: "/tools/social" },
];
