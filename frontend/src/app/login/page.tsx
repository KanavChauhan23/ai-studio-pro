        ...
        <div className="auth-glass au au1">
          <form onSubmit={submit} style={{ display:'flex', flexDirection:'column', gap:16 }}>
            <div className="field">
              ...
              <input className="fi" type="text" placeholder="Enter your username" value={u} onChange={e=>setU(e.target.value)} autoFocus />
            </div>
            <div className="field">
              <label className="flabel">Password</label>
              <input className="fi" type="password" placeholder="••••••••" value={p} onChange={e=>setP(e.target.value)} />
            </div>
